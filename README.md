...
*    Bustamante Leveau, Cameron Charllotte: Implementacion de Seccion Tecnico - Publicaciones de Tecnico y Agenda
*    De La Cruz Moreno, Roy Hernan:Implementacion de Seccion Cliente - Pagina Home del Cliente, Pagina Alertas del Cliente, Pagina Servicios Agendados del Cliente
*    Hallasi Saravia, Miguel Angel:Implementacion de Seccion Cliente - Json-Server, Catalogó de Trabajadores, Alertas
*    Muñiz Huayanca , Percy Alonso:Implementacion de Seccion Cliente - Perfiles de los Trabajadores y Agendar cita trabajador
*    Urrutia Peña, Jasmin Adriana:Implementacion de Seccion Tecnico -LogIn, Register, Agenda
